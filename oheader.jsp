		...
		<!--div class="container"-->
			...
			<div class="navigation">
			 <div class="navigation-bar">
				...
				<div class="top-menu">
					<ul>
          <li class="current"><a href="owner_home.jsp">Data_Owner_Home</a></li>
          <li><a href="upload.jsp">Upload Data</a></li>
           <li><a href="viewdata.jsp">Meta Data</a></li>
...
<h1><font size="" color="black">A Secure and Dynamic Multi-keyword Ranked
